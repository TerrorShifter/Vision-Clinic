/*
Deployment script for Vision Clinic
...
:setvar DefaultFilePrefix "Vision Clinic"
...
ALTER TABLE [dbo].[Appointments]
    ADD DEFAULT GETDATE() FOR [AppointmentDate];
...
GO
ALTER TABLE [dbo].[Appointments]
    ADD DEFAULT 0 FOR [Appointment_Patient];
...
GO
ALTER TABLE [dbo].[Appointments]
    ADD DEFAULT 0 FOR [AppointmentType];
...
GO
ALTER TABLE [dbo].[Appointments]
    ADD DEFAULT GETDATE() FOR [AppointmentTime];
...
ALTER TABLE [dbo].[InvoiceDetails]
    ADD DEFAULT 0 FOR [Invoice_InvoiceDetail];
...
GO
ALTER TABLE [dbo].[InvoiceDetails]
    ADD DEFAULT 0 FOR [Product_ProductID];
...
ALTER TABLE [dbo].[Invoices]
    ADD DEFAULT GETDATE() FOR [ShipDate];
...
GO
ALTER TABLE [dbo].[Invoices]
    ADD DEFAULT 0 FOR [InvoiceStatus];
...
GO
ALTER TABLE [dbo].[Invoices]
    ADD DEFAULT 0 FOR [Invoice_Patient];
...
GO
ALTER TABLE [dbo].[Invoices]
    ADD DEFAULT GETDATE() FOR [InvoiceDue];
...
GO
PRINT N'Creating [dbo].[FK_aspnet_Membership_ApplicationId_aspnet_Applications_ApplicationId]...';
...
GO
PRINT N'Creating [dbo].[FK_aspnet_Membership_UserId_aspnet_Users_UserId]...';
...
GO
PRINT N'Creating [dbo].[FK_aspnet_Users_ApplicationId_aspnet_Applications_ApplicationId]...';
...
GO
PRINT N'Creating [dbo].[FK_aspnet_Profile_UserId_aspnet_Users_UserId]...';
...
GO
PRINT N'Creating [dbo].[Appointment_Patient]...';


GO
ALTER TABLE [dbo].[Appointments]
    ADD CONSTRAINT [Appointment_Patient] FOREIGN KEY ([Appointment_Patient]) REFERENCES [dbo].[Patients] ([Id]);


GO
PRINT N'Creating [dbo].[FK_aspnet_UsersInRoles_UserId_aspnet_Users_UserId]...';
...
GO
PRINT N'Creating [dbo].[FK_aspnet_UsersInRoles_RoleId_aspnet_Roles_RoleId]...';
...
GO
PRINT N'Creating [dbo].[FK_aspnet_Paths_ApplicationId_Applications_ApplicationId]...';
...
GO
PRINT N'Creating [dbo].[Invoice_InvoiceDetail]...';


GO
ALTER TABLE [dbo].[InvoiceDetails]
    ADD CONSTRAINT [Invoice_InvoiceDetail] FOREIGN KEY ([Invoice_InvoiceDetail]) REFERENCES [dbo].[Invoices] ([Id]);


GO
PRINT N'Creating [dbo].[FK_aspnet_PersonalizationPerUser_UserId_aspnet_Users_UserId]...';
...
GO
PRINT N'Creating [dbo].[FK_aspnet_PersonalizationPerUser_PathId_aspnet_Paths_PathId]...';
...
GO
PRINT N'Creating [dbo].[Invoice_Patient]...';


GO
ALTER TABLE [dbo].[Invoices]
    ADD CONSTRAINT [Invoice_Patient] FOREIGN KEY ([Invoice_Patient]) REFERENCES [dbo].[Patients] ([Id]);


GO
PRINT N'Creating [dbo].[FK_aspnet_PersonalizationAllUsers_PathId_aspnet_Paths_PathId]...';
...
GO
PRINT N'Creating [dbo].[FK_aspnet_Roles_ApplicationId_aspnet_Applications_ApplicationId]...';
